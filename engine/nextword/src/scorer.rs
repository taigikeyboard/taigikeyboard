...
/// `decay <= 1`.
// 指數時間衰減;最近使用 ≈ 1.0、一週 ≈ 0.5、一個月 ≈ 0.06,時鐘倒退會 >1。
...
/// `LEARNING_BONUS`.
// 使用者層分數;含衰減下限與學習加成,確保同 count 下永遠贏字典條目。
