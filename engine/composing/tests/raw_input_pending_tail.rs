...
// 中文: 釘住 §10.2 不變式 (Model B):preedit.display_text == Phase::composing_display
// 中文: (整段組字);preedit.raw_input == Phase::Continuous.raw 原始 bytes
// 中文: (刻意非 Phase::raw_input — 後者走 derived chain,是既有引擎性質)。
