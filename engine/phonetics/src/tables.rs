...
// Legal TL initial set — used to validate whether a syllable head is well-formed.
...
// Legal TL final set — covers nasalization, stopped finals, diphthongs, and
// regional variants (ee/er/ir).
