...
INPUT_FILE = "data/05_merged/kautian.csv"
OUTPUT_DIR = "data/06_cleaned"
OUTPUT_FILE = "kautian.csv"
SCRIPT_NAME = "05_cleanup"
...
def main():
    ...
    df, dropped_df = cleanup_dataframe(df, logger=logger, preserve_spaces=True)
