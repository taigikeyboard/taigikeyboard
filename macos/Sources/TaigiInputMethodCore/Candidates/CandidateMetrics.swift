...
struct CandidateMetrics: Equatable, Sendable {
    ...
    /// stacked list in which NO cell carries an annotation — Romanization Only, or
    /// Hanji with Romanization's one-script cells — has nothing to put on a second line, and
