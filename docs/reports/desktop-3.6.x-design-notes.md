...
> **Type**: Historical
> **Keywords**: `desktop`, `macos`, `windows`, `telex`, `symbol picker`, `composing caret`, `slot key`, `快速齒`, `installed fonts`
...
- Verbatim design bodies of the six desktop sections that shipped in 3.6.8 and were collapsed out of `docs/roadmap.md` on 2026-09-13. Frozen: do not edit; the roadmap keeps status + commit + pending dogfood per item.
