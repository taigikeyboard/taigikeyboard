...
**Status**: Design approved (2026-06-19); implementation in progress — P0–P1 infra + P2 (English) shipped, P3a (Japanese) added to the production picker. **Full plan**: [`docs/architecture/i18n-multilang-plan.md`](architecture/i18n-multilang-plan.md); round-by-round status in memory.
