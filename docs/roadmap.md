...
**Active PR pointer**:current round = **Phase 9 fix-plan Item 6 — pin segmented dual-line rendering at platform UI** **In progress (branch `v358-item6-dual-line-render`)**(depends on Items 4 + 5,both merged)。Items 1/2/14 (spec foundation) shipped in PR #267;Item 3 (Enter-raw commit in Continuous) shipped in PR #268 (squash `29b5d437`,2026-05-14);Item 4 (Tap-0/Tap-N commit semantics — slot-0 cell removed from Continuous path, strict-required `displayText` sidechannel) shipped in PR #269 (squash `9a34d09a`,2026-05-14);Item 5 (`CandidateMessage` `roman` + `hanji` proto fields + iOS/Android bridge decode + defensive `roman.isEmpty → displayText` fallback) shipped in PR #270 (squash `1c18804c`,2026-05-14) — `(roman, hanji)` ranker dedupe **deferred to Item 12** per `dictionary/build/merge_csv.py` already merging duplicates pre-builder;Multi-word chain segmentation (§10.7 #2 case) is **out of scope for Item 6** and deferred to a future lattice/chain-producer slice;Items 7-13 remain per [`continuous-input-ranking.md` §10.10](engine/continuous-input-ranking.md)。Phase 0 merged in PR #248,Phase 1 merged in PR #249,Phase 1b N/A merged in PR #250 (squash `2c826b96`),Phase 2 merged in PR #251 (squash `f4c2e52f`),Phase 3 merged in PR #252 (squash `2f7feac1`),Phase 4 merged in PR #253 (squash `a69bfc75`),Phase 5 merged in PR #254 (squash `cf813af4`),Phase 6 merged in PR #255 (squash `c6f2ca42`),Phase 7A merged in PR #256 (squash `8c431af6`),Phase 7B merged in PR #257 (squash `65c2120c`),Phase 8 merged in PR #258 (squash `9fed869b`),Phase 9.1 merged in PR #262 (squash `86dd6253`),Phase 9.2 merged in PR #263 (squash `f5f2a3b2`),Phase 9.3a merged in PR #264 (squash `60601681`),Phase 9.3b merged in PR #265 (squash `a5d2fcdd`),Phase 9.3c merged in PR #266 (squash `0c0aa2ec`),Phase 9 spec foundation (items 1+2+14) merged in PR #267 (squash `2b65bd78`),Phase 9 Item 3 merged in PR #268 (squash `29b5d437`),Phase 9 Item 4 merged in PR #269 (squash `9a34d09a`),Phase 9 Item 5 merged in PR #270 (squash `1c18804c`)。
