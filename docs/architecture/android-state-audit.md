...
| 3 | Exclusions shrunk — roster ≥ 40 | ADVANCED | Running total 29 → 34 (+ToneConverter, +CandidateProcessor, +ComposingState via PR #160; +DictionaryError, +Outcome this PR). 6 short of ≥ 40 gate. All remaining candidates come from further `LexiconService` / `CustomDictionaryService` splits; no single-file structural blockers remain. |
