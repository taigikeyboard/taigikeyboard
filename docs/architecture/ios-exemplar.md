...
- **Candidate scoring** (`CandidateProcessor.swift`): recency window (`1 hour`), `cappedUserFreq` cap (`100`), user-freq multiplier (`100`), completion penalty (`-1000`), closeness max (`500`), exact bonus (`100`), recency bonus (`200`).
