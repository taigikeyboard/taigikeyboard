// 中文: 裝置能力偵測,提供 Settings 預設值的依據。
// 中文: 目前只用來決定地球鍵 (globe key) 是否預設顯示:iPad 與 Touch ID iPhone 預設開,Face ID iPhone 預設關。
