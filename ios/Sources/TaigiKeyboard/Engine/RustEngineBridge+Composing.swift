// 中文: RustEngineBridge 的 Composing 切片擴充 — v3.5.4 起,加上 v3.5.8 Phase 6 連續輸入 4 op。
// 中文: 含 12 composing op + 4 continuous op + 4 synthesized 型別 + composing 專屬 dispatch helper。
...
/// surface.
// 中文: Composing bridge 擴充入口。12+4 op + 4 個 synthesized 型別 + 5 個私有 composing 專屬 helper。
