...
public class ActionHandler: StandardKeyboardActionHandler {
    ...
    // KeyboardKit gesture entry: spacebar drag-end first, then release / repeatPress are dispatched to the
    // Taigi handler; anything unhandled falls through to super.
    ...
    // KeyboardKit entry for a candidate tap: English mode keeps the KK default, Taigi mode takes our path.
