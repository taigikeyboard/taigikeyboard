// 中文: DictionaryTab 詞典 info button 用的 metadata — 帶可切換顯示語言的說明文字 key。
// 中文: 每個 static 對應一个用 info 按鈕的詞典(iTaigi / 台日大辭典 …);說明文字經 i18n 解析。
...
// 中文: 詞典資訊 model — 存說明文字的 StringKey,顯示時才依目前顯示語言解析。
