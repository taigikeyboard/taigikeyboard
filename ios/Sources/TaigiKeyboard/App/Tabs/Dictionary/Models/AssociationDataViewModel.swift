// AssociationDataView 的 ViewModel — 聯想詞 CRUD + CSV 匯入匯出 + 錄製開關。
// 資料來源走 NextWordService(SQLite-backed),設定持久化交給 SharedSettings。
