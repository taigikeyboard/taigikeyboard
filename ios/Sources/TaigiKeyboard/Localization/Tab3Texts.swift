...
enum Tab3Texts {
    ...
    static let customDictEnabled = LocalizedText(hanji: "啟用自訂詞庫")
    static let customDictEnabledInfo = LocalizedText(hanji: "拍開了後，家己加入 ê 詞會出現佇候選詞內底。關起來了後，自訂詞就袂閣出現。")
    ...
    static let frequencyRecordingEnabled = LocalizedText(hanji: "開啟詞頻紀錄")
    static let frequencyRecordingEnabledInfo = LocalizedText(hanji: "拍開了後，齒盤會記錄你揀過 ê 詞幾擺，予候選詞排序做參考，定定揀 ê 詞就會排較頭前，按呢候選詞就會愈來愈準。")
    static let associationTab = LocalizedText(hanji: "詞關聯")
    static let associationManagement = LocalizedText(hanji: "詞關聯紀錄")
    static let associationRecordingEnabled = LocalizedText(hanji: "開啟詞關聯紀錄")
    static let associationRecordingEnabledInfo = LocalizedText(hanji: "拍開了後，齒盤會記錄頭前、後壁 ê 關聯詞，予連紲建議愈來愈準。")
