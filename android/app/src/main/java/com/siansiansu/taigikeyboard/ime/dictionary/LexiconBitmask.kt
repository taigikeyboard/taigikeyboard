// bitmask 解碼器 — 把 dictionary.bin 的 source bitmask 拆成 List<DictionarySource> 給 UI 顯示。
// 跨平台不變式:bit 位置必須與 source_bits.py / Rust dictionary_reader / iOS LexiconBitmask 三者對齊。
