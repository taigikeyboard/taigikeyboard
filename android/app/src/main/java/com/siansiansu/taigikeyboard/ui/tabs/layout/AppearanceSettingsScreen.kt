        ...
        Scaffold(
            ...
            Column(
                ...
                Column(
                    ...
                    SectionHeader(LayoutTexts.keyboardSection)
                    SettingsCard {
                    ...
                    SectionHeader(LayoutTexts.colorKeySection)
                    SettingsCard {
                        Column(modifier = Modifier.padding(24.dp)) {
                            ColorSettingRow(
                    ...
                    SectionHeader(LayoutTexts.candidateSection)
                    SettingsCard {
                        Column(modifier = Modifier.padding(24.dp)) {
                            ColorSettingRow(
                    ...
                    SettingsCard {
                        ActionRow(
                            label = LayoutTexts.appearanceResetAll,
                            onClick = {
